   ...
   public Whitebit (Object options) {
    ...
    public java.util.concurrent.CompletableFuture<java.util.List<io.github.ccxt.types.Order>> fetchOrders(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            var openOrdersclosedOrdersVariable = (Helpers.promiseAll(new java.util.ArrayList<Object>(java.util.Arrays.asList(this.fetchOpenOrders( (Object) (symbol), (Object) (since), (Object) (limit), (Object) (parameters)), this.fetchClosedOrders( (Object) (symbol), (Object) (since), (Object) (limit), (Object) (parameters)))))).join();
