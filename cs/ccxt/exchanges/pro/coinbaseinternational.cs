...
public partial class coinbaseinternational : ccxt.coinbaseinternational
{
     ...
     */
    public override Task<object> watchFundingRate(object symbol, object parameters = null)
    {
        parameters ??= new Dictionary<string, object>();
        return this.subscribe("RISK", new List<object>() {symbol}, parameters);
    }
     ...
     * @returns {object} A dictionary of [order book structures]{@link https://docs.ccxt.com/?id=order-book-structure}
     */
    public override Task<object> watchOrderBookForSymbols(object symbols, object limit = null, object parameters = null)
    {
        parameters ??= new Dictionary<string, object>();
