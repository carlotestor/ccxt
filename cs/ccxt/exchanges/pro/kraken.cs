...
public partial class kraken : ccxt.kraken
{
     ...
     * @returns {object[]} a list of [order structures]{@link https://docs.ccxt.com/?id=order-structure}
     */
    public override Task<object> watchOrders(object symbol = null, object since = null, object limit = null, object parameters = null)
    {
        parameters ??= new Dictionary<string, object>();
        return this.watchPrivate("orders", symbol, since, limit, this.extend(parameters, new Dictionary<string, object>() {
            { "snap_orders", true },
        }));
    }
